...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'schedule_attendance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Event'])),
            ('can_attend', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'schedule', ['Attendance'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'schedule_attendance')
    ...
    models = {
        ...
        u'schedule.attendance': {
            'Meta': {'object_name': 'Attendance'},
            'can_attend': ('django.db.models.fields.BooleanField', [], {}),
