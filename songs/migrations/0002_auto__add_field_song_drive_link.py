...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Song.drive_link'
        db.add_column(u'songs_song', 'drive_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Song.drive_link'
        db.delete_column(u'songs_song', 'drive_link')
    ...
    models = {
        ...
        u'songs.song': {
            ...
            'drive_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
